...
namespace ShapeGame.Speech
{
    ...
    public class SpeechRecognizer : IDisposable
    {
        ...
        private readonly Dictionary<string, WhatSaid> shapePhrases = new Dictionary<string, WhatSaid>
            {
                { "Seven Pointed Stars", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star5 } },
                { "Triangles", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star0 } },
                { "Squares", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star3 } },
                { "Boxes", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star3 } },
                { "Hexagons", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star4 } },
                { "Pentagons", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star2 } },
                { "Stars", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star1 } },
                { "Circles", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star6 } },
                { "Balls", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star6 } },
                { "Bubbles", new WhatSaid { Verb = Verbs.DoShapes, Shape = PolyType.Star7 } },
